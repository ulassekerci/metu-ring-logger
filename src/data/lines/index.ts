...
import { blueInboundPolyline } from './coordinates/blue-in'
import { blueOutboundPolyline } from './coordinates/blue-out'
import { brownInboundPolyline } from './coordinates/brown-in'
import { brownOutboundPolyline } from './coordinates/brown-out'
import { grayDayInboundPolyline } from './coordinates/gray-day-in'
import { grayDayOutboundPolyline } from './coordinates/gray-day-out'
import { grayNightInboundPolyline } from './coordinates/gray-night-in'
import { grayNightOutboundPolyline } from './coordinates/gray-night-out'
import { purpleInboundPolyline } from './coordinates/purple-in'
import { purpleOutboundPolyline } from './coordinates/purple-out'
import { redPolyline } from './coordinates/red'
import { yellowPolyline } from './coordinates/yellow'
  ...
  sections: [
    ...
    },
    {
      ...
      stops: [
        ...
        { stop: stops.yukselInbound, mins: 20 },
        { stop: stops.insaatDevrim, mins: 21 },
  ...
  sections: [
    ...
    },
    {
      ...
      stops: [
        ...
        { stop: stops.yukselInbound, mins: 23 },
        { stop: stops.insaatDevrim, mins: 24 },
        { stop: stops.kkmKavsak, mins: 25 },
        { stop: stops.rektorlukInbound, mins: 26 },
...
const grayDayLine = new RingLine({
  ...
  weekend: true,
  endTime: ServiceTime.fromLuxon(DateTime.fromObject({ hour: 19, minute: 20 })),
  sections: [
    {
      name: 'Outbound',
      color: '#737373',
      ...
      stops: [
        ...
        { stop: stops.odtukentSporInbound, mins: 11 },
        { stop: stops.teknokentInbound, mins: 12 },
    ...
    },
    {
      ...
      stops: [
        ...
        { stop: stops.yuksel, mins: 28 },
        { stop: stops.gidaGray, mins: 30 },
        { stop: stops.isaOutbound, mins: 31 },
        { stop: stops.havacilik, mins: 32 },
        { stop: stops.isaInbound, mins: 33 },
        { stop: stops.odtukentSporInbound, mins: 34 },
        { stop: stops.teknokentInbound, mins: 35 },
  ...
  sections: [
    {
      ...
      stops: [
        ...
        { stop: stops.yukselInbound, mins: 12 },
        { stop: stops.insaatDevrim, mins: 13 },
    ...
    },
    {
      ...
      stops: [
        ...
        { stop: stops.odtukentSporInbound, mins: 33 },
        { stop: stops.teknokentInbound, mins: 34 },
        { stop: stops.egitimInbound, mins: 36 },
        { stop: stops.boteInbound, mins: 37 },
        { stop: stops.garajlar, mins: 38 },
        { stop: stops.a2Metro, mins: 39 },
